...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=os.path.join(data_root, 'annotations/instances_train_20191004_mmd_100.json'),
...
log_level = 'INFO'
work_dir = os.path.join(PROJECT_HOME, 'data/work_dirs/cascade_rcnn_r50_fpn_400')
